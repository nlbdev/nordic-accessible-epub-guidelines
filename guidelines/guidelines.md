...
- [Nordic Guidelines for the Production of Accessible EPUB 3](#nordic-guidelines-for-the-production-of-accessible-epub-3)
    ...
    - [2 Format Requirements](#2-format-requirements)
        ...
        - [2.5 Content Documents](#25-content-documents)
            - [2.5.1 XHTML](#251-xhtml)
                - [2.5.1.1 XML Declaration and Encoding](#2511-xml-declaration-and-encoding)
                - [2.5.1.2 Document Type Declaration](#2512-document-type-declaration)
                - [2.5.1.3 HTML Root Attributes](#2513-html-root-attributes)
                - [2.5.1.4 Namespaces](#2514-namespaces)
                - [2.5.1.5 Language Definition](#2515-language-definition)
    ...
    - [3 General Requirements for Content Documents](#3-general-requirements-for-content-documents)
        - [3.1 Structural Divisons and Semantics](#31-structural-divisons-and-semantics)
        - [3.2 File Naming Convention](#32-file-naming-convention)
        - [3.3 Special Content Requirements](#33-special-content-requirements)
            - [3.3.1 Cover](#331-cover)
            - [3.3.2 Title Page](#332-title-page)
            - [3.3.3 Parts](#333-parts)
        - [3.4 Mark-up Requirements](#34-mark-up-requirements)
            - [3.4.1 Pagination](#341-pagination)
            - [3.4.2 Headings](#342-headings)
            - [3.4.3 Figures](#343-figures)
                - [3.4.3.1 Text Extraction from Images](#3431-text-extraction-from-images)
                - [3.4.3.2 Alt-texts](#3432-alt-texts)
                - [3.4.3.3 Image Series](#3433-image-series)
            - [3.4.4 Lists](#344-lists)
                - [3.4.4.1 Numbered Lists](#3441-numbered-lists)
                - [3.4.4.2 Unnumbered Lists](#3442-unnumbered-lists)
                - [3.4.4.3 Tables of Contents](#3443-tables-of-contents)
            - [3.4.5 Tables](#345-tables)
            - [3.4.6 Definition Lists](#346-definition-lists)
            - [3.4.7 Notes and Note References](#347-notes-and-note-references)
            - [3.4.8 Sidebars, Text Boxes etc.](#348-sidebars-text-boxes-etc)
            - [3.4.9 Computer Code](#349-computer-code)
            - [3.4.10 Bolding and Italics](#3410-bolding-and-italics)
            - [3.4.11 Poetry and Verse](#3411-poetry-and-verse)
            - [3.4.12 Quotes](#3412-quotes)
        - [3.5 Thematic Breaks in the Text Flow](#35-thematic-breaks-in-the-text-flow)
    ...
    - [5 Appendix](#5-appendix)
        ...
        - [5.2 Language Dependent Fixed Text Values](#52-language-dependent-fixed-text-values)
            - [5.2.1 nav.xhtml Headings](#521-navxhtml-headings)
            - [5.2.2 aria-label Values](#522-aria-label-values)
            - [5.2.3 Image Alternative Text Values](#523-image-alternative-text-values)
            - [5.2.4 schema.org Accessibility Metadata Values](#524-schemaorg-accessibility-metadata-values)

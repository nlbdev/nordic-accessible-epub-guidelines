...
For convenience, the values for all the main languages (English, Swedish, Norwegian (Bokmål, Nynorsk), Finnish, Dutch, Danish, Icelandic, and German) of the Ordering Agencies are listed in the tables below. The Ordering Agencies will provide Suppliers with canonical translations if the main language of a title is not one of those listed here.
